...
import com.example.gitapiapplication.Screens.IssuesScreen;
...
//        holder.reposLayout.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                String reponame=repos.get(position).getName();
//                Intent intent = new Intent(context.getApplicationContext(), IssuesScreen.class);
